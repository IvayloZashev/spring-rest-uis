...
public class CityController {
    ...
    @ResponseBody public List<City> listCity() {
        return cityDAO.selectAllCities();
    }

    @RequestMapping(value = "/addCity", method = RequestMethod.GET)
    @ResponseBody public String create(@RequestParam(value = "name") String name, @RequestParam(value = "countryId") int countryId) {
        cityDAO.insertCity(name, countryId);
        return "Inserted city"+ name;
    }

    @RequestMapping(value = "/editCity", method = RequestMethod.POST)
    @ResponseBody public String edit(@RequestParam(value = "name") String name, @RequestParam(value = "countryId") int countryId, @RequestParam(value = "id") int id) {
    ...
    @ResponseBody public String delete(@RequestParam(value = "id") int id) {
